...
public class MyPtrHandler implements PtrUIHandler {
    ...
    public void onUIRefreshBegin(PtrFrameLayout frame) {
        tip.setText(R.string.load_status_loading);
    ...
    public void onUIRefreshComplete(PtrFrameLayout frame) {
        tip.setText(R.string.load_status_complete);
//        Toast.makeText(context, "Load Complete!!", Toast.LENGTH_SHORT).show();
        Toast.makeText(context,R.string.load_status_complete,Toast.LENGTH_SHORT).show();
    }*/
